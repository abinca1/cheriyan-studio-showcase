...
import { Image, apiService } from '../../../shared/services/api';
        ...
        <Card key={image.id} className="overflow-hidden group hover:shadow-lg transition-shadow">
          ...
          <div className="aspect-square relative overflow-hidden bg-gray-100">
            ...
            <div className="absolute top-2 left-2 flex space-x-1">
              ...
              <Badge variant={image.is_public ? "secondary" : "outline"} className="text-xs">
                {image.is_public ? (
                  <>
          ...
          {/* Content */}
          <CardContent className="p-4">
            <h3 className="font-medium text-gray-900 mb-1 truncate" title={image.title}>
              {image.title}
            </h3>
            
            {image.description && (
              <p className="text-sm text-gray-600 mb-2 line-clamp-2" title={image.description}>
                {image.description}
              </p>
            )}
