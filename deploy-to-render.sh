...
echo "=================="
echo "If build fails with 'build.sh: command not found':"
echo "  1. Use: cp backend/render-minimal.yaml backend/render.yaml"
echo "  2. Redeploy in Render dashboard"
echo "  3. Database will initialize on first startup"
echo ""
echo "📖 Full troubleshooting guide: RENDER_TROUBLESHOOTING.md"
echo ""
